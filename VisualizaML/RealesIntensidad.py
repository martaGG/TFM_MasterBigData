...
mod=MLPRegressor(hidden_layer_sizes=(73,73), alpha=0.001, solver='lbfgs')
...
plt.ylabel('real')
plt.legend()
plt.savefig('IndiceRealIntensidad.jpg')


dClass=datos['Shape']+datos['Compo']
modClas=MLPClassifier(hidden_layer_sizes=(43,43), alpha=1.0, solver='lbfgs')
