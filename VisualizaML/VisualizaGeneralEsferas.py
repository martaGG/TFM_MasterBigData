...
"""
PROGRAMA BÁSICO DE VISUALIZACIÓN DE UNA SERIE DE ELEMENTOS DE LA MATRIZ DE SCATTERING, 
A TODOS LOS POSIBLES ÁNGULOS        

Es un programa para esferas, en la que se considerarán solo 4 elementos.
"""
...
f11=pd.read_csv('./F11_EsfR1.csv')
f12=pd.read_csv('./F12_F11_EsfR1.csv')
f33=pd.read_csv('./F33_F11_EsfR1.csv')
f34=pd.read_csv('./F34_F11_EsfR1.csv')
...
plt.savefig('AllSphereCarbonR1Def.pdf')
plt.close()
#plt.show()
