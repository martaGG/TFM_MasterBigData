...
pkl_filename = "RegresionIndicePolarizacionCV.pkl"  
...
mlp=MLPRegressor(hidden_layer_sizes=(49,49), solver='lbfgs', alpha=0.001)
mlpfit=mlp.fit(scalTrain, trainClass)
scalTest=scal.transform(testFeats)
predTest=mlpfit.predict(scalTest)
plt.plot(predTest, testClass, 'o')